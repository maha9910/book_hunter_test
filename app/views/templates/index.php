        ...
        <aside class="w-full md:w-1/4 p-3">
            <div class="bg-gray-700 rounded-lg shadow-lg p-4">
                ...
                <ul class="list-reset">
                    ...
                    <li>
                        <a class="text-gray-300 hover:text-white" href="#">Science-fiction</a>
                    </li>
                </ul>
            </div>
        ...
        <main class="w-full md:w-3/4 p-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <article class="bg-gray-800 rounded-lg overflow-hidden shadow-lg relative">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="text-xl font-bold">Book 1</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <article class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                    <img class="w-full h-48 object-cover" src="https://source.unsplash.com/480x360/?movie" alt="Movie Cover" />
                    <div class="p-4">
                        <h3 class="text-xl font-bold mb-2">Author 1</h3>
                        <div class="flex items-center mb-2">
                ...
                <div class="flex w-full lg:w-1/2">
                    <div class="px-8">
                        ...
                        <p class="py-4 text-sm">
                            ...
                            Maecenas vel libero dui. Aliquam pharetra, quam a rhoncus
                            venenatis, velit dolor gravida nunc, nec efficitur felis magna
                            eu tellus.
                        </p>
                    </div>
                </div>
                <div class="flex w-full lg:w-1/2 lg:justify-end lg:text-right">
                    <div class="px-8">
                        ...
                        <ul class="list-reset items-center text-sm">
                            <li>
                                <a class="inline-block hover:text-white hover:underline py-1" href="#">
